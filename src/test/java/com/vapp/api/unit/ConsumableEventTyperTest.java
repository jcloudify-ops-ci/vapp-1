...
import com.vapp.api.conf.FacadeIT;
import com.vapp.api.endpoint.event.consumer.model.ConsumableEvent;
import com.vapp.api.endpoint.event.consumer.model.ConsumableEventTyper;
import com.vapp.api.endpoint.event.consumer.model.TypedEvent;
import com.vapp.api.endpoint.event.model.UuidCreated;
...
public class ConsumableEventTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent = new TypedEvent("com.vapp.api.endpoint.event.model.UuidCreated", payload);
  ...
  void to_acknowledgeable_typed_event_ko() throws JsonProcessingException {
    ...
    var validTypedEvent = new TypedEvent("com.vapp.api.endpoint.event.model.UuidCreated", payload);
