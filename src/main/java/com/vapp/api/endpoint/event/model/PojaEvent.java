package com.vapp.api.endpoint.event.model;

import static com.vapp.api.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import com.vapp.api.PojaGenerated;
import com.vapp.api.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "com.vapp.api.event1";
    return "com.vapp.api.event2";
  }
}
