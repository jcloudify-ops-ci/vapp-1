package com.vapp.api.endpoint.event.consumer;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.vapp.api.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.vapp.api.service.event." + typeNameAsArray[typeNameAsArray.length - 1] + "Service";
  }
